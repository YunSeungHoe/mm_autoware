...
def launch_setup(context, *args, **kwargs):
    ...
    cropbox_parameters["input_frame"] = "lidar"
    cropbox_parameters["output_frame"] = "lidar"
    ...
    nodes.append(
        ComposableNode(
            ...
            remappings=[
                ...
                ("output", LaunchConfiguration("output_pointcloud")),
...
def generate_launch_description():
    ...
    add_launch_arg("vehicle_info_param_file", description="path to the file of vehicle_param_file yaml")
    ...
    add_launch_arg("output_pointcloud", "outlier_filtered/pointcloud")
    add_launch_arg("input_pointcloud", "lidar/pointcloud")
